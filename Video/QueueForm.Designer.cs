namespace iviewer.Video
{
	partial class QueueForm
	{
		...
		private void InitializeComponent()
		{
			...
			tabQueue.Anchor = AnchorStyles.Left | AnchorStyles.Right | AnchorStyles.Bottom | AnchorStyles.Top;
			tabQueue.Location = new Point(0, 12);
			tabQueue.Name = "tabQueue";
			tabQueue.SelectedIndex = 0;
			tabQueue.Size = new Size(784, 549);
			tabQueue.TabIndex = 0;
			// 
			// tabVideos
			// 
			...
			tabVideos.Size = new Size(776, 521);
			...
			chkOrder.Location = new Point(323, 2);
			chkOrder.Name = "chkOrder";
			chkOrder.Size = new Size(90, 19);
			chkOrder.TabIndex = 1;
			chkOrder.Text = "Newest First";
			chkOrder.UseVisualStyleBackColor = true;
			// 
			// QueueForm
			// 
			ClientSize = new Size(784, 561);
			Controls.Add(chkOrder);
			Controls.Add(btnAdd);
